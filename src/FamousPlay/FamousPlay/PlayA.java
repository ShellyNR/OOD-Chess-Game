...
public class PlayA implements FamousPlay{
    ...
    public List<Move> setAPlayerMovesForSolveQuiz() {
        ...
        moveList.add(new Move(new Spot(6,4, c.get("PawnW")),new Spot(4,4, c.get("PawnW"))));
        moveList.add(new Move(new Spot(7,6, c.get("KnightW")),new Spot(5,5, c.get("KnightW"))));
        moveList.add(new Move(new Spot(7,1, c.get("KnightW")),new Spot(5,2, c.get("KnightW"))));
        moveList.add(new Move(new Spot(5,5, c.get("KnightW")),new Spot(3,4, c.get("KnightW"))));
        return moveList;
    }
    ...
    public List<Move> setBPlayerMovesForSolveQuiz() {
        List<Move> moveList = new ArrayList<>();
        moveList.add(new Move(new Spot(1,4, c.get("PawnB")),new Spot(3,4, c.get("PawnB"))));
        moveList.add(new Move(new Spot(0,1, c.get("BishopB")),new Spot(2,2, c.get("BishopB"))));
        moveList.add(new Move(new Spot(0,6, c.get("BishopB")),new Spot(2,5, c.get("BishopB"))));
        return moveList;
    }
