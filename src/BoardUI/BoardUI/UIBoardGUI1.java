...
public class UIBoardGUI1 extends JFrame implements UIBoard {
    ...
    private BoardNotifier listener;
    ...
    public void setListener(BoardNotifier l) {
        this.listener = l;
    }
    ...
    public void addBoardListener(BoardListener ml) {
        this.listener.addBoardListener(ml);
    }
    ...
    private final void setupNewGame() {
        ...
        for (int i = 0; i < currentPositionS.length; i++) {
            for (int j = 0; j < currentPositionS.length; j++) {
                ...
                this.listener.addBoardNotifier(chessBoardSquares[i][j]);
